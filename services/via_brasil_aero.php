...
if ( in_array( 'woocommerce/woocommerce.php', apply_filters( 'active_plugins', get_option( 'active_plugins' ) ) ) ) {
	...
	function via_brasil_aero_validate_order($posted) {
        ...
        // if (is_array($chosen_methods) && in_array('melhorenvio_via_brasil_aero', $chosen_methods)) {
        //     foreach ($packages as $i => $package) {
        //         if ($chosen_methods[$i] != "melhorenvio_via_brasil_aero") {
        //             continue;
        //         }
        //         $via_brasil_aero_Shipping_Method = new WC_Via_Brasil_Aero_Shipping_Method();
        //         $weightLimit = (int)$via_brasil_aero_Shipping_Method->settings['weight'];
        //         $weight = 0;
