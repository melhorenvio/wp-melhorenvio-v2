...
class WoocommerceCorreiosCalculoDeFreteNaPaginaDoProduto {
    ...
    public function enqueue_css_js_frontend() {
        wp_enqueue_script( 'produto', plugins_url('melhor-envio-cotacao/assets/js/shipping-product-page.js'), 'jquery');
    }
            ...
            <div id="woocommerce-correios-calculo-de-frete-na-pagina-do-produto">
                ...
                <div class="calculo-de-frete">
                    ...
                    <div id="calcular-frete">
                        <img src="<?php echo  plugins_url('melhor-envio-cotacao/assets/img/truck.png') ?>" />
                        <span>Calcular Frete</span>
                    </div>
                </div>
                <div id="calcular-frete-loader" style="display:none;">
                    <img src="<?php echo  plugins_url('melhor-envio-cotacao/assets/img/loader.gif') ?>" />
                </div>
