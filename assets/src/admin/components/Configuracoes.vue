            ...
            <label :for="option.id">
              ...
              <div class="wpme_address-body">
                <ul>
                  ...
                  <li>
                    <b>Tempo extra:</b>
                    {{ showTimeWithDay(option.time) }}
                  </li>
                  <li>
                    <b>Taxa extra:</b>
                    R$ {{ formatNumber(option.tax) }}
                  </li>
                  <li>
                    <b>Percentual extra:</b>
                    {{ formatPercent(option.perc) }}%
                  </li>
                </ul>
                <hr />
              ...
              <transition name="fade">
                <div
                  class="me-modal"
                  v-show="codeshiping[option.code] && codeshiping[option.code]['status']"
                >
                  <div>
                    ...
                    <div class="content">
                      <ul>
                        <li>
                          ...
                          <input
                            v-model="option.name"
                            v-on:keyup="requiredInput(option.name)"
                            type="text"
                            class="input"
                            maxlength="100"
                          />
                          ...
                          <label>
                            <b>Tempo extra</b>
                            <br />Será adicionado ao tempo de previsão de entrega
                          </label>
                          <br />
                          ...
                          <label>
                            <b>Taxa extra</b>
                            <br />Será adicionado um valor extra para o cliente sobre o valor da cotação.
                          </label>
                          <br />
                          <div class="group-input">
                          ...
                          <label>
                            <b>Percentual extra</b>
                            <br />Será adicionado um valor de percentual extra para o cliente sobre o valor da cotação.
                          </label>
                          <br />
                          <div class="group-input">
                    ...
                    <div class="buttons -center box-buttons">
                      <button
                        v-show="canUpdate"
                        @click="closeShowModalEditMethod()"
                        type="button"
